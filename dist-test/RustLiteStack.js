...
class RustLiteStack {
    ...
    push(value) {
        ...
        this.stackPointer += RustLiteTypes_1.word_size;
    }
    pop() {
    ...
    dump() {
        ...
        for (let i = 0; i < this.stackPointer; i += RustLiteTypes_1.word_size) {
            if (i == framePointer) {
    ...
    getLocalFromFrame(frameIndex, offset) {
        ...
        const index = frame.basePointer + offset * RustLiteTypes_1.word_size;
